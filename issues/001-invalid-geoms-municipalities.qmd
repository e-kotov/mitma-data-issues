...
# issue-number: 1
# repo-url: https://github.com/e-kotov/mitma-data-issues
categories:
    - spatial data
    - geometry
---

<!-- **Discuss**: [in GitHub issue #{{< meta issue-number >}}]({{< meta repo-url >}}/issues/#{{< meta issue-number >}}) -->
...
# DT::datatable(files |> filter(basename(local_path) %in% basename(c(municipal_boundaries_data_file, municipality_names_file))))
